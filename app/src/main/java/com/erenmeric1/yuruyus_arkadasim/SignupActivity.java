...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup(View view) {
        ...
        try {
            ...
            Log.d("erenSignUp1", e.getLocalizedMessage().toString());
            return;
        }
                        ...
                        if (task.isSuccessful()) {
                            ...
                            mRootRef.child("Users").child(mAuth.getCurrentUser().getUid()).setValue(map)
                                ...
                                public void onFailure(@NonNull  Exception e) {
                                    ...
                                    Log.d("erenSignUp", e.getLocalizedMessage().toString());
                                }
                            });
                            ...
                            Toast.makeText(getApplicationContext(), task.getException().toString(),
                                    Toast.LENGTH_LONG).show();
                            Log.d("erenSignUp2", task.getException().toString());
                            //pd.dismiss();
                        }
                    }
                });
        ...
        User userToReg = new User(name, username, city, mail, password ,age, gender);
        firebaseAuth.createUserWithEmailAndPassword(mail, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Log.d("erenSignUp3", e.getLocalizedMessage().toString());
            }
        });
